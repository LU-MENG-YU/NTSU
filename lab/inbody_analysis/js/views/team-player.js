(function(B){
  ...
  V.renderTeam=()=>{
    ...
    for(const id of ['year','level','position','method','team-mode','team-unit'])U.bind(id,'change',()=>{t.year=U.val('year');t.filter={level:U.val('level'),position:U.val('position')};if(t.unit!=='week')t.method=U.val('method');t.mode=U.val('team-mode');t.unit=U.val('team-unit');V.renderTeam();});
